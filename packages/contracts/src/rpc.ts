...
export const WsServerUpdateTelegramNotificationsRpc = Rpc.make(
  WS_METHODS.serverUpdateTelegramNotifications,
  {
    payload: ServerUpdateTelegramNotificationsInput,
    success: ServerUpdateTelegramNotificationsResult,
    error: ServerTelegramNotificationsError,
  },
);

export const WsServerSendTestTelegramNotificationRpc = Rpc.make(
  WS_METHODS.serverSendTestTelegramNotification,
  {
    payload: ServerSendTestTelegramNotificationInput,
    success: ServerSendTestTelegramNotificationResult,
    error: ServerTelegramNotificationsError,
  },
);
...
export const WsProjectsBrowseDirectoryRpc = Rpc.make(WS_METHODS.projectsBrowseDirectory, {
  payload: ProjectBrowseDirectoryInput,
  success: ProjectBrowseDirectoryResult,
  error: ProjectBrowseDirectoryError,
});
...
export const WsGitPushRpc = Rpc.make(WS_METHODS.gitPush, {
  payload: GitPushInput,
  success: GitPushResult,
  error: GitCommandError,
});

export const WsGitCommitRpc = Rpc.make(WS_METHODS.gitCommit, {
...
export const WsGitReadWorkingTreeFileDiffRpc = Rpc.make(WS_METHODS.gitReadWorkingTreeFileDiff, {
  payload: GitReadWorkingTreeFileDiffInput,
  success: GitReadWorkingTreeFileDiffResult,
  error: GitCommandError,
});
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsServerUpdateTelegramNotificationsRpc,
  WsServerSendTestTelegramNotificationRpc,
  WsProjectsBrowseDirectoryRpc,
  ...
  WsGitPushRpc,
  WsGitCommitRpc,
  WsGitReadWorkingTreeFileDiffRpc,
  WsGitStageFilesRpc,
