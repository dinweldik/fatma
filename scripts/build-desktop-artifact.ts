...
const BuildEnvConfig = Config.all({
  ...
  mockUpdates: Config.boolean("FATMA_DESKTOP_MOCK_UPDATES").pipe(Config.withDefault(false)),
  mockUpdateServerPort: Config.string("FATMA_DESKTOP_MOCK_UPDATE_SERVER_PORT").pipe(Config.option),
});
...
const buildDesktopArtifactCli = Command.make("build-desktop-artifact", {
  ...
  mockUpdates: Flag.boolean("mock-updates").pipe(
    Flag.withDescription("Enable mock updates (env: FATMA_DESKTOP_MOCK_UPDATES)."),
    Flag.optional,
  ),
  mockUpdateServerPort: Flag.string("mock-update-server-port").pipe(
    Flag.withDescription("Mock update server port (env: FATMA_DESKTOP_MOCK_UPDATE_SERVER_PORT)."),
    Flag.optional,
  ),
}).pipe(
