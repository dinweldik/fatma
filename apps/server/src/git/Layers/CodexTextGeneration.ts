...
import { CodexModelSelection } from "@fatma/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@fatma/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `fatma-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
