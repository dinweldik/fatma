            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  FATMA_PORT: "4001",
                  FATMA_HOST: "0.0.0.0",
                  FATMA_HOME: join(os.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  FATMA_NO_BROWSER: "false",
                  FATMA_AUTH_TOKEN: "ignored-token",
                  FATMA_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  FATMA_HOME: baseDir,
                  FATMA_NO_BROWSER: "true",
                  FATMA_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  FATMA_LOG_WS_EVENTS: "true",
                },
              }),
            ),
