...
import type { SidebarProjectSortOrder, SidebarThreadSortOrder } from "@fatma/contracts/settings";
...
export function getVisibleThreadsForProject<TThread extends Pick<Thread, "id">>(input: {
  threads: readonly TThread[];
  activeThreadId: TThread["id"] | undefined;
