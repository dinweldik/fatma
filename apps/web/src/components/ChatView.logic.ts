import { ProjectId, type ModelSelection, type ThreadId, type TurnId } from "@fatma/contracts";
...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "fatma:last-invoked-script-by-project";
