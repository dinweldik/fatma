...
export interface WsRpcClient {
  ...
  readonly projects: {
    readonly browseDirectory: RpcUnaryMethod<typeof WS_METHODS.projectsBrowseDirectory>;
  ...
  readonly git: {
    ...
    readonly push: RpcUnaryMethod<typeof WS_METHODS.gitPush>;
    readonly commit: RpcUnaryMethod<typeof WS_METHODS.gitCommit>;
    readonly status: RpcUnaryMethod<typeof WS_METHODS.gitStatus>;
    readonly readWorkingTreeFileDiff: RpcUnaryMethod<typeof WS_METHODS.gitReadWorkingTreeFileDiff>;
  ...
  readonly server: {
    ...
    readonly updateTelegramNotifications: RpcUnaryMethod<
      typeof WS_METHODS.serverUpdateTelegramNotifications
    >;
    readonly sendTestTelegramNotification: RpcUnaryMethod<
      typeof WS_METHODS.serverSendTestTelegramNotification
    >;
  ...
  return {
    ...
    projects: {
      browseDirectory: (input) =>
        transport.request((client) => client[WS_METHODS.projectsBrowseDirectory](input)),
    ...
    git: {
      ...
      push: (input) => transport.request((client) => client[WS_METHODS.gitPush](input)),
      commit: (input) => transport.request((client) => client[WS_METHODS.gitCommit](input)),
      status: (input) => transport.request((client) => client[WS_METHODS.gitStatus](input)),
      readWorkingTreeFileDiff: (input) =>
        transport.request((client) => client[WS_METHODS.gitReadWorkingTreeFileDiff](input)),
    ...
    server: {
      ...
      updateTelegramNotifications: (input) =>
        transport.request((client) => client[WS_METHODS.serverUpdateTelegramNotifications](input)),
      sendTestTelegramNotification: (input) =>
        transport.request((client) => client[WS_METHODS.serverSendTestTelegramNotification](input)),
